...
# ==========================================
# 🤖 ANA KOMUT İŞLEYİCİ (GELİŞTİRİLMİŞ ESNEK MOTOR)
# ==========================================
def process_command(user_input):
    ...
    # Esnek Transfer Algılama (Aktar, transfer, geçir, gönder, taşı)
    ...
    if is_transfer:
        ...
        if len(bulunanlar) >= 2:
            ...
            # Eğer -dan / -den eki varsa kaynak depodur
            ...
            # Depo adı hiç yazılmadıysa varsayılan depoları ata (Aktif depodan diğerine)
